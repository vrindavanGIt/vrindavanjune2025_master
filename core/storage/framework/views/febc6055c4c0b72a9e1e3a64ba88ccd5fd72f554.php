            ...
            <div class="section__table">
                <div class="modal show" id="modalCompose">
                    <div class="modal-dialog">
                        <div class="modal-header modal-header-info">
                            ...
                            <h4><a href="<?php echo e(url('admin/orders')); ?>">[Order #<?php echo e($emailData['Order_id']); ?>]</a>
                                <span>(<?php echo e(date('F d, Y', strtotime($order_details['created_at']))); ?>)</span>
                ...
                <div class="top-container">
                    <div class="success-inner">
                        <h3><span>You've received the following order from <?php echo e($billing_info['bill_first_name']); ?>

                                <?php echo e($billing_info['bill_last_name']); ?></span></h3>
                    ...
                    <table>
                        ...
                        <?php $__currentLoopData = $cart_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <?php if($billing_info['bill_country'] != 'India'): ?>
                                    <td style="text-align: center">
                                        $<?php echo e(round($item['main_price'] / $order_details['usd_rate'], 2)); ?></td>
                                <?php endif; ?>
                            </tr>
                        ...
                        <tr>
                            ...
                            <?php if($shipping != null && is_array($shipping) && isset($shipping['price'])): ?>
                                <td style="text-align: center;font-size: 15px;"><b> &#8377;
                                        <?php echo e(round($shipping['price'] * $order_details['currency_value'], 2)); ?></b>
                                </td>
                            <?php else: ?>
                                <td style="text-align: center;font-size: 15px;"><b> &#8377; 0</b></td>
                            <?php endif; ?>
                            <?php if($billing_info['bill_country'] != 'India'): ?>
                                <td style="text-align: center;font-size: 15x;">
                                    <b>$<?php echo e(round($shipping['price'] / $order_details['usd_rate'], 2)); ?></b></td>
                            <?php endif; ?>
                        </tr>
                        <?php if($billing_info['bill_country'] != 'India'): ?>
                            <tr>
                                ...
                                <td style="text-align: center">&#8377;
                                    <?php echo e(round((PriceHelper::OrderTotalWithoutNumberformat($order_details) * $order_details['paypal_fee']) / 100, 2)); ?>

                                </td>
                                <?php if($billing_info['bill_country'] != 'India'): ?>
                                    <td style="text-align: center">
                                        $<?php echo e(round((PriceHelper::OrderTotalWithoutNumberformat($order_details) * $order_details['paypal_fee']) / 100 / $order_details['usd_rate'], 2)); ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;font-size: 15px;"><b>&#8377;
                                    <?php echo e(round($grand_total_paypal, 2)); ?></b></td>
                            <?php if($billing_info['bill_country'] != 'India'): ?>
                                <td style="text-align: center;font-size: 15px;">
                                    <b>$<?php echo e(round($grand_total_paypal / $order_details['usd_rate'], 2)); ?></b></td>
                            <?php endif; ?>
                        </tr>
                        <?php if($order_details['payment_status'] == 'Partially Paid' && isset($order_details['cod_payment'])): ?>
                            <tr>
                                ...
                                <td style="text-align: center;font-size: 15px;"><b>
                                        <?php echo e($order_details->currency_sign); ?><?php echo e(PriceHelper::testPrice($order_details['cod_payment'])); ?></b>
                                </td>
                            ...
                            <tr>
                                ...
                                <?php if($order_details['payment_status'] == 'Partially Paid' && isset($order_details['cod_payment'])): ?>
                                    <td style="text-align: center;font-size: 15px;"><b>
                                            <?php echo e($order_details->currency_sign); ?><?php echo e(PriceHelper::testPrice($grand_total_paypal - $order_details['cod_payment'])); ?>

                                        </b></td>
                                <?php else: ?>
                                    <td style="text-align: center;font-size: 15px;"><b>
                                            <?php echo e($order_details->currency_sign); ?><?php echo e(PriceHelper::testPrice($grand_total_paypal)); ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center" colspan="2"> <?php echo e(__('Cash On Delivery')); ?></td>
...
<?php /**PATH /home/r4cwncamkd2i/public_html/vrindavantulsimala.com/core/resources/views/front/admin_mail_templete.blade.php ENDPATH**/ ?>