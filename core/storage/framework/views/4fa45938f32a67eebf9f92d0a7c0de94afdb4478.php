                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control item-name"
                            id="name" oninput="this.value = this.value.toLowerCase()" placeholder="<?php echo e(__('Enter Name')); ?>"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" class="form-control"
                            ...
                            value="<?php echo e("Product-". App\Models\Item::nextProdutId()); ?>">
                    </div>
                    <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/r4cwncamkd2i/public_html/vrindavantulsimala.com/core/resources/views/back/item/digital/create.blade.php ENDPATH**/ ?>